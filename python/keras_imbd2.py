...
model.add(layers.Dense(4, kernel_regularizer=regularizers.l2(0.001), activation='relu', input_shape=(10_000, ))) # zeroes out the negatives
...
model_hist = model.fit(partial_x_train, partial_y_train, epochs=100, batch_size=512, validation_data=(x_val, y_val))

print(model_hist.history.keys())
loss = model_hist.history['loss']
acc = model_hist.history['binary_accuracy']
